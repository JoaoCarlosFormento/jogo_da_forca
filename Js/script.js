let confere = [' _ '], letrasCorretas = [], letErrada = [], result = '', numImag = 1
...
function iniciarJogo(){
    ...
    document.getElementById('btInicia').disabled = true
    document.getElementById('btInicia').focus()
}
...
function verificaLetra(){
    ...
    if(!confere.includes(letra)){
        ...
        numImag++
        let nomeImg = './Assets/' + numImag + '.png'
        ...
        if(numImag >= 7){
            ...
            document.getElementById('tituloPag').innerHTML = "Você não acertou a palavra secreta, mocreia!"
